...
public:
    ...
    rclcpp::Subscription<liorf::msg::CloudInfo>::SharedPtr subLaserCloudInfo;
    ...
    FeatureExtraction(const rclcpp::NodeOptions & options) :
        ParamServer("liorf_featureExtraction", options)
    {
        subLaserCloudInfo = create_subscription<liorf::msg::CloudInfo>(
            "liorf/deskew/cloud_info", QosPolicy(history_policy, reliability_policy),
        ...
        pubLaserCloudInfo = create_publisher<liorf::msg::CloudInfo>(
            "liorf/feature/cloud_info", QosPolicy(history_policy, reliability_policy));
        pubCornerPoints = create_publisher<sensor_msgs::msg::PointCloud2>(
            "liorf/feature/cloud_corner", QosPolicy(history_policy, reliability_policy));
        pubSurfacePoints = create_publisher<sensor_msgs::msg::PointCloud2>(
            "liorf/feature/cloud_surface", QosPolicy(history_policy, reliability_policy));
